...
Mag_PINN = readmatrix("PredMag_GridTestData1968T6561_NN6_40_swish_noEmb_Adam_RADk1c0n3000d600_nEpo12000_BS3000_Seed12345.dat");
Bx_PINN = Mag_PINN(:,4);
By_PINN = Mag_PINN(:,5);
Bz_PINN = Mag_PINN(:,6);
...
% ========== Row 1: Bx component ==========
ax1 = nexttile;
contourf(ax1, x_unique, y_unique, Bx_ref_grid');
...
% ========== Row 2: By component ==========
ax4 = nexttile;
contourf(ax4, x_unique, y_unique, By_ref_grid');
...
% ========== Row 3: Bz component ==========
ax7 = nexttile;
contourf(ax7, x_unique, y_unique, Bz_ref_grid');
